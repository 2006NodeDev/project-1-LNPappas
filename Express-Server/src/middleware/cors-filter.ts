...
export function corsFilter(req:Request, res:Response, next:NextFunction) {
    ...
    res.header('Access-Control-Allow-Origin', `https://storage.googleapis.com/pictures.lnpappas.com`);
    res.header('Access-Control-Allow-Origin', `https://storage.googleapis.com/project1.lnpappas.com`);
